...
define( 'CPI_PORTAL_DIR', get_template_directory_uri() );

include(CPI_PORTAL_DIR . 'template_filter.php');
include(CPI_PORTAL_DIR . 'include/oel-cmp-scripts.php');
include(CPI_PORTAL_DIR . 'include/ajax-handaler.php');
