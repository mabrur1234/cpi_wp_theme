...
function ($stateProvider, $locationProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        ...
        url: "/fixed-header",
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/dashboard-2.html",
        resolve: loadSequence('d3', 'ui.knob', 'countTo', 'dashboardCtrl'),
        title: 'Fixed Header',
        ncyBreadcrumb: {
            label: 'Fixed Header'
        ...
        url: "/fixed-sidebar",
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/dashboard-3.html",
        resolve: loadSequence('d3', 'ui.knob', 'countTo', 'dashboardCtrl'),
        title: 'Fixed Sidebar',
        ncyBreadcrumb: {
            label: 'Fixed Sidebar'
        ...
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/dashboard-4.html",
        resolve: loadSequence('d3', 'ui.knob', 'countTo', 'dashboardCtrl'),
        ...
        url: "/fixed-footer",
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/dashboard-5.html",
        resolve: loadSequence('d3', 'ui.knob', 'countTo', 'dashboardCtrl'),
        title: 'Fixed Footer',
        ncyBreadcrumb: {
            label: 'Fixed Footer'
        ...
        url: "/boxed-page",
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/dashboard.html",
        ...
        url: "/layouts",
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/layouts.html",
        title: 'Layouts',
        ncyBreadcrumb: {
            label: 'Layouts'
        }
        ...
        url: '/basic',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/table_basic.html",
        title: 'Basic Tables',
        ncyBreadcrumb: {
            label: 'Basic'
        }
        ...
        url: '/responsive',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/table_responsive.html",
        ...
        url: '/dynamic',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/table_dynamic.html",
        ...
        url: '/data',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/table_data.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        ...
        url: '/export',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/table_export.html",
        title: 'Table'
    }).state('app.form', {
        url: '/form',
        template: '<div ui-view class="fade-in-up"></div>',
        ...
        url: '/elements',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/form_elements.html",
        ...
        url: '/pickers',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/form_pickers.html",
        title: 'Pickers',
        ncyBreadcrumb: {
            label: 'Pickers'
        },
        ...
        url: '/xeditable',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/form_xeditable.html",
        ...
        url: '/editor',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/form_text_editor.html",
        title: 'Text Editor',
        ncyBreadcrumb: {
            label: 'Text Editor'
        },
        ...
        url: '/wizard',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/form_wizard.html",
        title: 'Form Wizard',
        ncyBreadcrumb: {
            label: 'Wizard'
        },
        ...
        url: '/validation',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/form_validation.html",
        ...
        url: '/image-cropping',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/form_image_cropping.html",
        ...
        url: '/user',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/pages_user_profile.html",
        title: 'User Profile',
        ncyBreadcrumb: {
            label: 'User Profile'
        },
        ...
        url: '/invoice',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/pages_invoice.html",
        title: 'Invoice',
        ncyBreadcrumb: {
            label: 'Invoice'
        }
        ...
        url: '/timeline',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/pages_timeline.html",
        title: 'Timeline',
        ncyBreadcrumb: {
            label: 'Timeline'
        },
        ...
        url: '/calendar',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/pages_calendar.html",
        title: 'Calendar',
        ncyBreadcrumb: {
            label: 'Calendar'
        },
        ...
        url: '/messages',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/pages_messages.html",
        resolve: loadSequence('inboxCtrl')
    }).state('app.pages.messages.inbox', {
        url: '/inbox/:inboxID',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/pages_inbox.html",
        controller: 'ViewMessageCrtl'
    }).state('app.pages.blank', {
        url: '/blank',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/pages_blank_page.html",
        ncyBreadcrumb: {
            label: 'Starter Page'
        }
    }).state('app.utilities', {
        ...
        url: '/search',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/utility_search_result.html",
        ...
        url: '/pricing',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/utility_pricing_table.html",
        title: 'Pricing Table',
        ncyBreadcrumb: {
            label: 'Pricing Table'
        }
        ...
        url: "/maps",
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/maps.html",
        ...
        url: "/charts",
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/charts.html",
        ...
        url: '/404',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/utility_404.html",
    }).state('error.500', {
        url: '/500',
        templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/utility_500.html",
    })
	...
	.state('login', {
	    ...
	    url: '/lock',
	    templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/login_lock_screen.html"
	})
	...
	.state('landing', {
	    ...
	    url: '/welcome',
	    templateUrl: siteUrl+"/wp-content/plugins/oel-cmp/templates/assets/views/landing_page.html"
	});
