...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'appCtrl': siteUrl+'/wp-content/plugins/oel-cmp/templates/assets/js/controllers/appCtrl.js',
    ...
    modules: [{
        ...
        files: [siteUrl+'/wp-content/plugins/oel-cmp/bower_components/angular-file-upload/angular-file-upload.min.js']
    }, {
