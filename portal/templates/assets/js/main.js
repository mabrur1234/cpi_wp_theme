...
app.run(['$rootScope','$location', '$state', '$stateParams','authFact','$cookies',
function ($rootScope, $location, $state, $stateParams, authFact, $cookies) {
	...
	$rootScope.$on('$stateChangeStart', function (event, next, current) {
		...
		if(next.authenticated){
			var userAuth = authFact.getAccessToken('user-obj');
			if(!userAuth){
    ...
    $rootScope.app = {
		...
		url:'http://clippingpathindia.dev',
        ...
        defaultLayout: {
            ...
            logo: siteUrl+'/wp-content/plugins/oel-cmp/templates/assets/images/logo.png', // relative path of the project logo
            logoCollapsed: siteUrl+'/wp-content/plugins/oel-cmp/templates/assets/images/logo-collapsed.png' // relative path of the collapsed logo
        },
        layout: ''
    };
...
function ($translateProvider) {
    ...
    $translateProvider.useStaticFilesLoader({
        prefix: siteUrl+'/wp-content/plugins/oel-cmp/templates/assets/i18n/',
        suffix: '.json'
    });
